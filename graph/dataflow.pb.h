...
class ModelDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:dataflow.ModelDef) */ {
 public:
  ModelDef();
  virtual ~ModelDef();
  ...
  void clear_node_def();
  static const int kNodeDefFieldNumber = 1;
  const ::dataflow::NodeDef& node_def(int index) const;
  ::dataflow::NodeDef* mutable_node_def(int index);
  ::dataflow::NodeDef* add_node_def();
  ::google::protobuf::RepeatedPtrField< ::dataflow::NodeDef >*
      mutable_node_def();
  const ::google::protobuf::RepeatedPtrField< ::dataflow::NodeDef >&
      node_def() const;

  // @@protoc_insertion_point(class_scope:dataflow.ModelDef)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::dataflow::NodeDef > node_def_;
